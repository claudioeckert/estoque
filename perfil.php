              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Alteração do cadastro</h1>
                  </div>
                  <form class="user">
                    ...
                    <div>
                      <input type="file" class="btn btn-primary" name="imagem" id="imagem">
                      <button type="file" class="btn btn-primary">Primary</button>
                      <input type="submit" class="btn btn-primary btn-user btn-block" value="Upload Image" name="submit">
                    </div>
